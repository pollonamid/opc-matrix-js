...
OPC.prototype.writePixels = function()
{
  ...
  this.lastPixelBuffer = this.pixelBuffer;
...
OPC.prototype.mapPixels = function(fn)
{
  ...
  this.setPixelCount(this.model.length);
  var offset = 4;
...
OPC.prototype.getLastPixelBuffer = function()
{
  return this.lastPixelBuffer;
}

OPC.prototype.getBufferPixel = function(pixel){ //Gibt die Farbwerte des Pixels in einer Liste zur�ck
  var red, green, blue;
  var offset = 4 + pixel * 3;
  blue = this.pixelBuffer[offset + 2];
  green = this.pixelBuffer[offset + 1];
  red = this.pixelBuffer[offset];
...
OPC.prototype.mapParticles = function(particles)
{
  ...
  this.mapPixels(shader);
}

OPC.prototype.mapXY = function(x, y, r, g, b)
{
  if(y % 2 === 0) {
    var num = y * 10 + x;
  }
